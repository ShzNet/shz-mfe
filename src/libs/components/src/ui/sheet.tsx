...
function SheetOverlay({ className, ...props }: React.ComponentProps<typeof DialogPrimitive.Overlay>) {
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        'data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-50 bg-black/55 backdrop-blur-md supports-[backdrop-filter]:bg-black/45 dark:bg-black/70 dark:supports-[backdrop-filter]:bg-black/55',
        className
      )}
      {...props}
    />
