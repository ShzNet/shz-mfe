...
const distPackageJsonPath = resolve(workspaceRoot, 'tools/create-shznet-workspace/dist/package.json')
...
const result = spawnSync(
  'pnpm',
  ['publish', './tools/create-shznet-workspace/dist', '--registry', registry, '--access', 'public', '--no-git-checks'],
  {
    cwd: workspaceRoot,
    stdio: 'inherit',
  }
