function buildHomePageTsx(options) {
  return `import { Link } from 'react-router-dom'
import { Badge, Card, CardContent, CardDescription, CardHeader, CardTitle } from '${options.componentsPackage}'
...
const recentActivity = [
  { title: 'Remote manifest refreshed', time: '5 minutes ago' },
    ...
    <div className='flex min-h-svh flex-col bg-muted/30'>
      <header className='flex h-16 items-center justify-between border-b bg-background px-6'>
        <div className='flex items-center gap-3'>
          ...
          <div>
            <p className='text-sm font-semibold tracking-tight'>${options.displayName}</p>
      ...
      <main className='mx-auto flex w-full max-w-7xl flex-1 flex-col gap-4 p-4 md:p-6'>
        <div className='flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between'>
          <div>
            <h1 className='text-2xl font-bold tracking-tight'>${options.displayName} Dashboard</h1>
...
module.exports = { buildHomePageTsx }
