function buildSignInPageTsx(options) {
  return `import type { FormEvent } from 'react'
import { useState } from 'react'
import { LogIn } from 'lucide-react'
import { Button, Card, CardContent, CardDescription, CardHeader, CardTitle, Input, Label } from '${options.componentsPackage}'
...
module.exports = { buildSignInPageTsx }
